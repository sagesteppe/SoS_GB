...
<qgis styleCategories="AllStyleCategories" minScale="1e+08" version="3.22.7-Białowieża" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" nodataColor="" band="1" opacity="1" type="paletted">
      ...
      <colorPalette>
        <paletteEntry alpha="255" label="1" value="1" color="#edf8e9"/>
        <paletteEntry alpha="255" label="2" value="2" color="#bae4b3"/>
        <paletteEntry alpha="255" label="3" value="3" color="#74c476"/>
        <paletteEntry alpha="255" label="4" value="4" color="#238b45"/>
      </colorPalette>
