...
# see if this works!!!!!!
counties <- apply(my_counties, MARGIN = 1, state =  STUSPS, county = NAME)

roads()
ggplot() +
  geom_sf(data = my_counties, fill = NA) +
  geom_sf(data = fo_boundary, fill = 'red', alpha = 0.4)
...
project_maker <- function(project_areas, crew_id, 
