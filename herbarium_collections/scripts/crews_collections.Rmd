...
time_USDA_plants_lkp <- system.time({
...
time_directions_grabber <- system.time({ # write directions to sites
  ...
  data1 <- directions_grabber(data[1:50,], api_key = SoS_gkey)
  data2 <- directions_grabber(data[52:67,], api_key = SoS_gkey)
  data <- bind_rows(data1, data[51,], data2, data[51,])
})
