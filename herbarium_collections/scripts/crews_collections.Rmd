...
```{r load and run reeds last collection, eval = F}
data <- read_sheet('1iOQBNeGqRJ3yhA-Sujas3xZ2Aw5rFkktUKv3N_e4o8M', 
...
data <- data %>% 
  select(-'Site...51', Site = 'Site...53')

data <- directions_grabber(data, api_key = SoS_gkey)
cols <- read_sheet('1iOQBNeGqRJ3yhA-Sujas3xZ2Aw5rFkktUKv3N_e4o8M', 
             sheet = 'Processed - Examples') %>% 
  colnames()
...
write_sheet(data, '1iOQBNeGqRJ3yhA-Sujas3xZ2Aw5rFkktUKv3N_e4o8M', 
                    sheet = 'Processed - Examples')
```
